<template>
  <div class="main">
    ...
    <van-tabbar v-model="activeName" route inactive-color="#646566" active-color="#0C34BA">
      <van-tabbar-item :icon="item.icon" v-for="(item, index) in tabbarData" :key="index" :name="item.name" replace :to="Home">
