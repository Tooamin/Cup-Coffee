  ...
  <div class="home">
    ...
    <div class="main-content">
      <div class="content-box">
        ...
        <div class="fun-box">
          <div class="fun-item">
            <div class="fun-img"><img src="../assets/images/xianzaixiadan.png" alt=""></div>
            <div class="fun-title">现在下单</div>
          </div>
          <div class="fun-item">
            <div class="fun-img"><img src="../assets/images/kafeiqianbao.png" alt=""></div>
            <div class="fun-title">咖啡钱包</div>
          </div>
          <div class="fun-item">
            <div class="fun-img"><img src="../assets/images/songcoffee.png" alt=""></div>
            <div class="fun-title">送TA咖啡</div>
          </div>
        </div>
        <div class="title-text">今日推荐</div>
        <div class="pro-recommended-box">
