    ...
    <div class="introduce">
      <div class="introduce-box">
        ...
        <div class="productintroduction">
          ...
          <div class="introduction-item">1.独特的黑糖风味拿铁，佐以Q嫩儒糯的黑糖口味珍珠，创造出层次丰富的美妙口感。（建议搅拌后饮用）</div>
          <div class="introduction-item">2.主要原材料：浓缩咖啡，黑糖味珍珠，纯牛奶，黑糖味调味糖浆，原味调味糖浆，可选择添加搅打奶油（含香草风味糖浆）</div>
          <div class="introduction-item">3.图片仅供参考，请以实物为准，建议取餐后尽快饮用。</div>
        </div>
      </div>
    </div>
  </div>
