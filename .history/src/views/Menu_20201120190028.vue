      ...
      <div class="content">
        ...
        <div class="pro-content">
          <div class="pro-sidebar">
            ...
            <van-sidebar v-model="activeKey" @change="SidebarIndex">
              <van-sidebar-item :title="item.title" v-for="(item,index) in sidebarData" :key="index" />
            </van-sidebar>
            </van-sticky>
          </div>
...
export default {
  ...
  methods: {
    getSidebarIndex(index){
      ...
      let typedata = ["isHot","latte","coffee","rena_ice"]
