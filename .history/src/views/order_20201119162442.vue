    ...
    <Bgbox :title="toptitle">
      <Contentbox>
        ...
        >
          ...
          >
            <div>
              <Probox v-for="(v,k) in orderData" :key="k" :order-number="v.oid" :order-time="v.date | formatDate('yyyy-MM-dd hh:mm:ss')" :pro-numberof="v.count" :pro-pricetotal="v.total">
                <Productitem v-for="(i,n) in v.data" :key="n"></Productitem>
              </Probox>
            </div>
          </van-tab>
        </van-tabs>
