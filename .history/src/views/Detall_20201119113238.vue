<template>
  <div class="detall">
    <div class="pro-img">
      ...
      <div class="like-box" @click="getLikeProduct">
        <div class="like-icon"><van-icon name="like" @click="getLikeProduct" :color="isLike ? '#0C34BA' : '#FFFFFF'"/></div>
        <div class="like-title">{{isLike ? '已收藏' : '未收藏'}}</div>
      </div>
    </div>
    <div class="introduce">
      <div class="introduce-box">
        ...
        <div class="buttom-box">
          ...
          <div class="shopbtn">
            <div class="shop-icon" @click="goShopBag"><van-icon name="shopping-cart-o" /></div>
          </div>
