  ...
  <div class="shopbag">
    ...
    >
      <div class="shopbag-pro">
        <div class="topnav">
          <div class="clear"><van-icon name="delete" @click="removeSelected"/>清空</div>
        </div>
        <div
          class="shopbag-item"
        ...
        >
          <van-swipe-cell>
            <div class="checkbox">
              <van-checkbox v-model="item.isChecked" @change="simpleSelect" checked-color="#7186c7"></van-checkbox>
            </div>
            ...
            <template #right>
              <van-button square text="删除" type="danger" @click="removeSelected(index,item.sid)"/>
            </template>
          </van-swipe-cell>
        </div>
      </div>
    ...
    <div class="submit">
      <van-submit-bar :price="total" button-text="提交订单" label=" ">
        <van-checkbox v-model="isAllChecked" @click="allSelect" checked-color="#7186c7">全选</van-checkbox>
      </van-submit-bar>
    </div>
  </div>
</template>
