  ...
  <div class="detall">
    ...
    <div class="introduce">
      <div class="introduce-box">
        ...
        <div class="procount"><van-stepper v-model="product.count"  button-size="34px"/></div>
        <div class="shopbtn">
          <div class="shop-icon"><van-icon name="shopping-cart-o" /></div>
        </div>
        <div class="joinshop">
          <van-button color="#0c34ba"><span class="text">加入购物车</span><span class="price"></span></van-button>
        </div>
        </div>
      </div>
    </div>
